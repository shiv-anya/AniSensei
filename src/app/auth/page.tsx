...
export default function Login() {
  ...
  return (
    <section className="h-screen w-full bg-black bg-contain bg-right-top bg-no-repeat bg-[url('./assets/superman.jpg')] flex flex-col items-center justify-between pt-8">
      {message && <p className="fixed right-5 top-5 text-3xl">{message}</p>}
      <h2 className="text-4xl font-semibold font-lucky z-30">Anisensei</h2>
      <div className="flex justify-center pt-28 absolute left-0 top-0 h-screen w-full bg-black/30">
        <div className="bg-[#1b1b1b]/50 p-10 backdrop-blur-sm w-1/4 h-[85%] rounded-xl flex flex-col gap-4">
